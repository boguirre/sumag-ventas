@section('title', 'Módulo De Ventas')
        ...
        <div class="col-md-12">
            <div class="flex-wrap d-flex justify-content-between align-items-center" style="color: black">
                ...
                <div>
                    ...
                    <a href="{{ route('venta.create') }}" class="btn btn-primary" style="color: white; border-radius: 12px">
                      ...
                      <a href="{{route('venta.reporte')}}" class="btn btn-warning" style="color: white; border-radius: 12px">
