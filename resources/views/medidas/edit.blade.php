  ...
  <div class="row">
      <div class="col-md-12">
          <div class="flex-wrap d-flex justify-content-between align-items-center" style="color: black">
              <div>
                  <h1>Editar Unidad De Medidas</h1>
              </div>
              {{-- <div>
...
<div class="row">
    <div class="col-sm-12 col-lg-12">
        <div class="card">
            ...
            <div class="card-body">
                {!! Form::model($medida, ['route' => ['medida.update', $medida], 'method' => 'put','files'=>true, 'class'=>'formulario']) !!}
                <div class="form-group">
                        <label class="form-label" for="codigo">Codigo:</label>
                        <input type="text" class="form-control" id="codigo" name="codigo" placeholder="Ingrese El Codigo" value="{{$medida->codigo}}">
                        @error('codigo')
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="nombre" name="nombre" placeholder="Ingrese El Nombre" value="{{$medida->nombre}}">
                        @error('nombre')
                        <strong class="text-sm text-red-600" style="color: red">{{$message}}</strong>
                    @enderror 
                    </div>
