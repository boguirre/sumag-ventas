@section('title', 'Reporte Pago De Proveedores')
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="flex-wrap d-flex justify-content-center align-items-center" style="color: black">
                    <div>
                        <h1 class="text-center">REPORTE DE PAGOS A PROVEEDORES!</h1>
            ...
            <div class="card" data-aos="fade-up" data-aos-delay="800">
                <div class="flex-wrap card-header d-flex justify-content-center align-items-center">
                    <div class="header-title ">
                        ...
                        <p class="mb-0 text-center"> <b>PAGOS POR PROVEEDORES</b></p>
                    </div>
        ...
        <div class="col-md-12 col-lg-12">
            <div class="card" data-aos="fade-up" data-aos-delay="800">
                <div class="flex-wrap card-header d-flex justify-content-center align-items-center">
                    <div class="header-title ">
                        {{-- <h4 class="card-title text-center">$855.8K</h4> --}}
                        <p class="mb-0 text-center"> <b>PAGOS A PROVEEDORES POR EMPRESAS</b></p>
                    </div>


                </div>
                <div class="card-body">
                    <div id="chartprestamo2"></div>
                </div>
            </div>
        </div>
    </div>
...
@section('scripts')
    ...
    <script>
        $(document).ready(function() {
            const cData = JSON.parse(`<?php echo $reportempresas; ?>`)
            console.log(cData);
            ...
            var chart = new ApexCharts(document.querySelector("#chartprestamo2"), options);
            chart.render();
        })
    </script>
