        ...
        <section class="login-content">
            <div class="row m-0 align-items-center bg-white vh-100">
                <div class="col-md-6 d-md-block d-none bg-primary p-0 mt-n1 vh-100 overflow-hidden">
                    <img src="/images/auth/05.png" class="img-fluid gradient-main animated-scaleX"
                        alt="images">
                </div>
                <div class="col-md-6">
                                ...
                                <div class="card-body">
                                    ...
                                    <form>
                                        ...
                                        <p class="mt-3 text-center">
                                            Ya tienes una cuenta <a href="{{route('login')}}" class="text-underline">Iniiciar Sesion</a>
                                        </p>
                                    </form>
                                </div>
                            </div>
