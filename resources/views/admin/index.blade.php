                                ...
                                @foreach ($alertaduas as $alertadua)
                                    ...
                                    <div id="alerts-disimissible-component" class="tab-pane tab-example-result fade active show" role="tabpanel" aria-labelledby="alerts-disimissible-component-tab">
                                        <div class="alert alert-success alert-dismissible fade show " role="alert">
                                          ...
                                          <strong>Atención!!!</strong> Su DUA esta por recoger en la fecha <b class="text-black">  {{ Date::parse($alertadua->mes_cobro)->locale('es')->format('l j F') }}</b>
                            ...
                            <div class="card-body">
                                ...
                                <div id="alerts-disimissible-component" class="tab-pane tab-example-result fade active show" role="tabpanel" aria-labelledby="alerts-disimissible-component-tab">
                                    <div class="alert alert-success alert-dismissible fade show " role="alert">
                                      ...
                                      <strong>Atención!!!</strong> El Comprobante esta por cobrar en la fecha <b class="text-black">  {{Date::parse($comprobante->fecha_pago)->locale('es')->format('l j F') }}</b>
