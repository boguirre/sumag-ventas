        ...
        <div class="row">
            <div class="col-md-12">
                <div class="flex-wrap d-flex justify-content-between align-items-center" style="color: black">
                    ...
                    <div>
                        <a href="{{ route('proveedor.create') }}" class="btn btn-primary" style="color: white; border-radius: 12px">
                        ...
                        <table id="datatable" class="table table-striped" data-toggle="data-table">
                            ...
                            <tbody>
                                @foreach ($proveedores as $proveedor)
                                    <tr>
                                        <td>
                                                <div style="background: {{ $proveedor->estado == 1 ? 'green' : 'red' }}; width: 25px; height: 25px; color: white; border-radius: 12px;" class="text-center">
                                                    {{ $proveedor->id }}
                                                </div>
                                        </td>
                                        ...
                                        <td class="text-center">
                                            <ul class="table-controls">
                                                    ...
                                                    @csrf
                                                    @method('DELETE')
                                                    <a href="{{ route('proveedor.edit', $proveedor) }}" class="bs-tooltip"
