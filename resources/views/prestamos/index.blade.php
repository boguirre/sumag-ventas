@section('title', 'Módulo  Prestamos')
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="flex-wrap d-flex justify-content-between align-items-center" style="color: black">
                    ...
                    <div>
                        <a href="{{ route('prestamo.create') }}" class="btn btn-primary" style="color: white; border-radius: 12px">
                            ...
                            <div class="card card-body">
                                ...
                                <div id="form-wizard1" class="">
                                    ...
                                    <fieldset style="display: block;">
                                        {!! Form::open(['route' => 'prestamo.pdf', 'autocomplete' => 'off', 'files' => true, 'class' => 'formulario']) !!}
                                        <div class="col-sm-12">
                                            <div class="row">
