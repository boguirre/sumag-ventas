            ...
            <div class="col-md-12">
                <div class="flex-wrap d-flex justify-content-between align-items-center" style="color: black">
                    ...
                    <div>
                        ...
                        <a href="{{ route('ingreso.create') }}" class="btn btn-primary" style="color: white; border-radius: 12px">
                                ...
                                @foreach ($ingresos as $ingreso)
                                    <tr>
                                        ...
                                        <td style="width: 50px;">
                                            ...
                                            <a href="{{route('ingreso.show', $ingreso)}}" class="jsgrid-button jsgrid-edit-button">
